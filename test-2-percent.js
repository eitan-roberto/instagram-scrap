...
const SIDE_CROP_PERCENT = 2;

console.log(`Original: ${width}x${height}`);
console.log('');

// 4:5 from TOP + 2% from each side
...
await sharp(inputImage)
  ...
  .toFile(`${outputDir}/crop-4-5-top-sides-2percent.jpg`);

console.log(`✅ 4:5 from TOP + ${SIDE_CROP_PERCENT}% from each side:`);
console.log(`   Original: ${width}x${height}`);
