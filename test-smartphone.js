...
async function main() {
  console.log('🎨 Testing smartphone-style photo...\n');
  ...
  // Generate with smartphone style - NO white borders
  const genResponse = await callGemini({
    contents: [{
      parts: [
        { text: `Create fashion photo: ${description}. Model has long dark hair as in reference.

Camera/Style: Photo taken with modern smartphone (iPhone/Samsung quality). Natural, candid aesthetic - NOT professional studio photography. Slight natural grain like real phone camera. Natural lighting, no heavy studio lights. Casual lifestyle feel like everyday Instagram post. NO white borders or frames - full bleed image.` },
